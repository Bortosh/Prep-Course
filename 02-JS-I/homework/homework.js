...
function obtenerSaludo(nombre) {
    ...
    var saludo = 'Hola';
    var exclamación = '!';
    var resultado = saludo + ' ' + nombre + exclamación;
    return resultado;
...
function areaDelTriangulo(base, altura) {
    ...
    //Escribe tu código aquí
    var calcule = base * altura;
    var calcule2 = calcule / 2;
    return calcule2;
